...
export const services = [
  {
    icon: {
      img: '/icons/icons8-access-64.png',
      alt: 'Mower Icon',
    },
    img: '/imgs/',
    alt: '',
    ...
    text: ' Our solutions range from: 1. Biometric (Fingerprint / Face etc.)A) FM-1000(with key pad) and FM-2000(without key pad) B) Fingkey Access C) NAC-2500 / NAC-2500 PLUS  D) IP-Finger007E) F3 Biometric Facial Access Control F) Fingkey Hamster : Fingerprint Registration Device 3. Digital Door Locks  A) With Handle : DUKE  B) Without Handle : CHAMP 2. Proximity Card Reader System (EM/Smart Cards etc.)   A) 513 (Stand Alone / On-Line) B) IP-RFL 200(Standlone), IP-RFL 200C(Network)   C) IP-100R, Stand alone   4. Network Access Control Units  For large capacity, this ACU can be used   together with readers',
    tags: [
      'Biometric (Fingerprint / Face etc.)',
      'Proximity Card Reader System (EM/Smart Cards etc.) ',
      'Network Access Control Units',
      ' Digital Door Locks',
    ]
  },
  {
    icon: {
      img: '/icons/icons8-attendance-50.png',
      alt: 'Time & Attendance System',
    },
    img: '/imgs/',
    alt: 'Man trimming hedge',
    subtitle: 'Time & Attendance System',
    title: 'Time & Attendance System',
    text: 'Time & Attendance Report : Using recorded time in/out data, various report can be made. 1. Biometric (Fingerprint / Face etc.) A) FM-1000(with key pad) and FM-2000(without key pad) B) Fingkey AccessC) NAC-2500 / NAC-2500 PLUS  D) IP-Finger007    E) Fingkey Hamster : Fingerprint Registration Device  F) Biometric Facial Time Attendance  2. Proximity Card Reader System (EM/Smart Cards etc.)   A) 513 (Stand Alone / On-Line) B) IP-RFL 200(Standlone), IP-RFL 200C (Network)   C) IP-100R, Stand alone',
    tags: [
      'Biometric (Fingerprint / Face etc.)',
      'Proximity Card Reader System (EM/Smart Cards etc.) ',
      ,
  ...
  {
    icon: {
      img: '/icons/icons8-dome-camera-52.png',
      alt: 'alt',
    },
    img: '/imgs/',
    alt: '',
    subtitle: '',
    title: 'CCTV System',
    text: 'We specialize in installation of high resolution IP CCTv systems including PTZ cameras. Our team of experts also works with you to make it possible for remote viewing over the internet, LAN as well as through mobile phone applications',
    tags: [
      'Camera',
      'IP Camera',
  ...
  {
    icon: {
      img: '/icons/icons8-smart-home-shield-64.png',
      alt: 'Garden Maintenance Icon',
    },
    img: '/imgs/',
    alt: 'Man pressure cleaning',
    subtitle: '',
    title: 'Wireless Alarm Home/Office Security System',
...
export const guarantee = [
  {
    ...
    text: 'At Levictus Security Management Limited, we believe that security should be accessible to everyone. Thats why we offer top-quality security solutions at prices that wont break the bank. With us, you can enjoy peace of mind without draining your budget.',
  },
  {
    title: 'Personalized Service',
    text: 'We understand that security needs vary from client to client. Thats why we take the time to listen to your unique requirements and preferences. Our personalized approach ensures that we tailor our solutions to meet your specific needs, providing you with security measures that are truly effective and suited to your situation.',
  },
  {
    title: 'Attention to Detail',
    text: 'We believe that the difference between a good security system and an exceptional one lies in the details. Thats why we pay meticulous attention to every aspect of our work, from the initial consultation to the final implementation. Whether its the installation of access control systems or the configuration of CCTV surveillance, we ensure that every component is executed with precision and care.',
  }
];
