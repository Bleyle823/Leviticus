      ...
      <div className="mx-auto flex flex-col gap-8 items-center justify-between">
        <div className="flex flex-row flex-wrap justify-start md:justify-center px-8 py-[50px] lg:py-[100px] gap-[50px] max-w-full md:w-[870px] min-[1650px]:w-full">
          ...
          <div className="flex flex-col gap-8 max-w-full md:max-w-[450px]">
            ...
            <p className="text-white font-lato leading-7 text-palette-5 text-[14px] sm:text-[16px]">Levictus Security Management Limited is a venture company in Kenya in pursuit of optimizing Africa systems security 
...
major success points. It looks like a small difference which we stick to but we believe surely big difference in the end.</p>
