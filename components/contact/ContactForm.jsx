    ...
    <div className="relative flex flex-col px-8 py-20 sm:px-20 lg:px-12 xl:px-20 leading-8 w-full max-w-[700px] bg-white">
      ...
      // Display contact form
        ...
        <div>
          ...
          <p className="text-palette-1">
            Whether you have questions, inquiries, or simply want to chat about your landscaping needs, we're here to help. Just fill out the form below, and we'll get back to you as soon as possible. 
          </p>
