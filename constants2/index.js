...
export const services2 = [
  {
    ...
    text: ' We install advanced systems for automatic management of all types of car parks offering end to end services. As each project is unique we do customized systems : entries, exits, traffic flow, guidance systems and access    management for every parking project. These include:   A) Bollards    1. Automatic_antiterror_bollard_275K4_700A    2. Automatic_bollard_275P_800A    B) Barrier   C) Ticket Dispenser   D) RF Card Reader   E) Pay Station   Benefits of Parking Management System:  »» Enhanced Security   »» Controlled Pilferege    »» Reduced Operating cost   »» Convenient for users   »» No conflicts of payments for number of hours parke',
    tags: [
      'Bollards',
      'Barrier ',
      'Ticket Dispenser',
